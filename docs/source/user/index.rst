...
.. note::
    ...
    .. code-block:: console
        ...
        (venv) $ pip install rastrea2r_server

The simplest way to install rastrea2r-server is using Pip.

.. code-block:: console

    $ pip install rastrea2r_server

This will install ``rastrea2r_server`` and all of its dependencies.
