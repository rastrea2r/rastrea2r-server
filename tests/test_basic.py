...
class BasicTestCase(unittest.TestCase):
    ...
    def test_basic_authentication(self):
        ...
        response = self.app.get('/rastrea2r/api/v1.0/echo?message=test', headers=headers)
    ...
    def test_method_not_allowed(self):
        ...
        response = self.app.delete('/rastrea2r/api/v1.0/echo?message=test', headers=headers)
    ...
    def test_valid_key_info(self):
        ...
        response = self.app.get('/rastrea2r/api/v1.0/info?key=remoteaddr', headers=headers)
